...
def main():
	...
	('hpa', 'horizontalpodautoscaler', ['g', 'd', 'e', 'rm'], None),
        ('jo', 'jobs', ['g', 'd', 'e', 'rm'], None),
        ('cjo', 'cronjobs', ['g', 'd', 'e', 'rm'], None),
        ('no', 'nodes', ['g', 'd', 'e', 't'], None),
        ('ns', 'namespaces', ['g', 'd', 'e', 'rm'], None),
        ('pdb', 'poddisruptionbudget', ['g', 'd', 'e', 'rm'], None),
        ('pc', 'priorityclass', ['g', 'd', 'e', 'rm'], None),
        ('pv', 'persistentvolume', ['g', 'd', 'e', 'rm'], None),
        ('pvc', 'persistentvolumeclaim', ['g', 'd', 'e', 'rm'], None),
	('sa', 'serviceaccount', ['g', 'd', 'e', 'rm'], None),
	('ss', 'statefulset', ['g', 'd', 'e', 'rm'], None),
        ]
